...
> [!NOTE]
> **Secret Masking & Encryption**: To maintain the simplicity of the Apache 2.0 core, advanced field-level encryption and log masking are prioritized for the **Talweg Enterprise** distribution. 
